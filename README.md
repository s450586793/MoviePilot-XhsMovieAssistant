...
[![Version](https://img.shields.io/badge/version-0.1.5-2d8a56)](https://github.com/s450586793/MoviePilot-XhsMovieAssistant/releases)
...
> `v0.1.5` 是公开测试版本。请先长期使用 dry-run 校准识别结果，再打开真实
...
当前 `v0.1.5` 发布验证结果为：Python `425 passed`、覆盖率 `88.97%`、Vue/Vitest
