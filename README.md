...
[![Version](https://img.shields.io/badge/version-0.1.7-2d8a56)](https://github.com/s450586793/MoviePilot-XhsMovieAssistant/releases)
...
> `v0.1.7` 是公开测试版本。请先长期使用 dry-run 校准识别结果，再打开真实
...
当前 `v0.1.7` 发布验证结果为：Python `428 passed`、覆盖率 `89.00%`、Vue/Vitest
